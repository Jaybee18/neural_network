...
where "list_for_hiddenlayer_architecture" is a list/array/tuple 
of integers which describe the number of neurons per layer e.g.:

[2, 3]

would be a Neural Network with 2 hidden layers. 
The first one has 2 and the second 3 Neurons.
